...
export default function Card() {
  return (
    ...
    >
      ...
      {/* Redes Sociales */}
      <div className="absolute bottom-[30px] w-[90%] left-[5%] flex justify-around text-[#00ff66] z-[30]">
        {/* WhatsApp */}
        <a href="#" className="flex flex-col items-center gap-1 hover:text-white hover:scale-110 transition-all duration-300 drop-shadow-[0_0_5px_#00ff66]" title="WhatsApp">
        ...
        {/* Instagram Personal */}
        <a href="#" className="flex flex-col items-center gap-1 hover:text-white hover:scale-110 transition-all duration-300 drop-shadow-[0_0_5px_#00ff66]" title="Instagram Personal">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
            <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path>
            <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line>
          </svg>
          <span className="text-[10px] uppercase tracking-wider font-bold">Insta</span>
        </a>

        {/* Instagram Equipo */}
        <a href="#" className="flex flex-col items-center gap-1 hover:text-white hover:scale-110 transition-all duration-300 drop-shadow-[0_0_5px_#00ff66]" title="Instagram Equipo">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
            <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path>
            <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line>
          </svg>
          <span className="text-[10px] uppercase tracking-wider font-bold">Equipo</span>
        </a>
      </div>
    </div>
  );
